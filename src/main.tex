...
\name{Andrew Simonson}
\tagline{Data Scientist Seeking Something Fun To Do}
\tiny{Subatomic Research Labs HMU}
...
\begin{itemize}
    ...
    \item Built anomalies and recommendations analysis, resulting in a 20\% increase in throughput and speed of service performance
\end{itemize}
\cvtag{Azure}
\cvtag{Databricks}
\cvtag{Apache Spark}
