...
\cvtag{SQL}
\cvtag{Object-Oriented Programming}\vspace{.15cm}
\cvtag{HTML}
\cvtag{CSS}
\vspace{.15cm}
...
\cveventShort{Rochester Institute of Technology}{Computer Science B.S.}{August 2021 -- May 2026}{Rochester, New York}
First Year in Sophomore Standing

\divider

\cveventShort{Boonsboro High School}{}{Sept 2016 -- June 2021}{Boonsboro, Maryland}
\textbf{Graduated with highest honors}\\
\textbf{GPA:} 4.2\\
\textbf{SAT:} 1500
